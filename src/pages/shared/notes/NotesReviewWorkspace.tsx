...
export default function NotesReviewWorkspace({
  ...
  const visibleNoteTypes = clientType === "sc"
    ? noteTypesForClientType("ddd").filter((note) => !["community-inclusion", "day-habilitation", "career-planning"].includes(note.id))
