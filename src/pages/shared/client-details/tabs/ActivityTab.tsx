...
export type ActivityTabProps = {
  ...
  itemsPerPage: number;
  /** Path template for shift details navigation. Omit to hide the details action. */
  shiftDetailsRoute?: string;
};
...
export function ActivityTab({
  ...
  const calculateDuration = useCallback(
    (
      start?: string | { _seconds?: number; _nanoseconds?: number } | Date,
      end?: string | { _seconds?: number; _nanoseconds?: number } | Date,
    ): string => {
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="space-y-3">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center gap-2 py-12 text-center">
                ...
                <p className="text-[14px] font-medium text-[#808081]">Loading shifts…</p>
              </div>
            ) : error ? (
                    ...
                    onDetails={
                      shiftDetailsRoute
                        ? () => {
                            ...
                            navigate(generatePath(shiftDetailsRoute, { shiftId: shift.id }));
                          }
                        : undefined
                    }
                  />
          ...
          <div className="flex items-center justify-center gap-2 pt-2">
            ...
            <button
              ...
              className="cursor-pointer rounded-full border border-[rgba(255,255,255,0.3)] bg-[rgba(255,255,255,0.5)] p-1.5 backdrop-blur-[2.909px] transition-colors hover:bg-white/70 disabled:cursor-not-allowed disabled:opacity-50"
