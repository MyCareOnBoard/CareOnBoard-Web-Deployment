...
export default function SlideFour({ onInnerComplete }: { onInnerComplete: (completed: boolean) => void }) {
  const mini = [
    ...
    // { title: "Have the following ready before starting:", text: "Official Hire & Orientation – Offer letter, system account setup, and full training schedule.", img: "/stage-4.png" },
