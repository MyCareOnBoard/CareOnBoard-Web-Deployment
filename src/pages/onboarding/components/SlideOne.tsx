...
export default function SlideOne() {
  return (
    <div className="flex flex-col items-center px-6 text-center gap-y-4 justify-evenly">
      <LogoHeader />
      <h2 className="mb-3 text-2xl font-bold text-gray-900">Thank you for your interest in joining our team .</h2>
      ...
      <p className="font-bold text-gray-600">The DDD requires all Staff to meet strict hiring, training, and background standards — this portal will guide you through each step of the process.</p>
    </div>
  )
}
