export default function SignupPage() {
  return (
    <div className="w-full rounded-lg bg-white p-8 shadow-md">
      ...
      <p className="mb-6 text-sm text-slate-500">Sign up to begin your onboarding journey.</p>
      <form className="space-y-4">
        <input className="w-full rounded-md border border-slate-200 p-2" placeholder="Full name" type="text" />
        ...
        <button type="submit" className="w-full rounded-md bg-[#00b4b8] py-2 text-white">Sign up</button>
      </form>
    </div>
  );
}
