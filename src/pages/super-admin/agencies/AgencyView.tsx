...
import {useGetSummaryAgencyInfoQuery, useUpdateAgencyStatusMutation} from "./api";
...
export default function AgencyView() {
    ...
    const mockUsers = Array(8).fill(null).map((_, i) => ({
        id: `user-${i}`,
                        ...
                        <div
                            ...
                            <div className="flex items-start gap-6">
                                ...
                                <div
                                    ...
                                    style={{backgroundColor: agency?.agencyData?.primaryColor || '#9EFF00'}}
                                >
                            ...
                            <div className="space-y-3">
                                {paginatedUsers.map((user) => (
                                    ...
                                    >
                                        {/* Avatar */}
                                        <div
                                            className="w-[60px] h-[60px] rounded-[8px] bg-[#e0e0e0] shrink-0 overflow-hidden">
                                            {user.avatar ? (
                                        ...
                                        <div className="flex-1 flex items-center gap-16">
                                            <div className="flex-1">
                                                <p className="text-[16px] font-semibold text-[#10141a]">{user.name}</p>
                                            </div>

                                            {/* Status Badge */}
                                            <div
                                                className="bg-[rgba(14,175,82,0.05)] border-[0.5px] border-[#0eaf52] px-4 py-2 rounded-[60px]">
                                                <p className="text-[12px] font-semibold text-[#0eaf52]">{user.status}</p>
                                            </div>

                                            {/* DSP Count */}
                                            <div className="w-[75px]">
                                                <p className="text-[14px] text-[#808081] font-medium">DSP</p>
                                                <p className="text-[14px] text-[#10141a] font-medium">{user.dsp}</p>
                                            </div>
                                            ...
                                            <div className="w-[129px]">
                                                <p className="text-[14px] text-[#808081] font-medium">Account
                                                    Created</p>
                                                <p className="text-[14px] text-[#10141a] font-medium">{user.accountCreated}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
