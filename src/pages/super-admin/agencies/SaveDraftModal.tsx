...
export function SaveDraftModal({open, onOpenChange, onSave, isLoading}: SaveDraftModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent
                className="bg-white border border-[rgba(255,255,255,0.3)] rounded-[30px] p-[19px] max-w-[426px]">
