  ...
  const [conversations, setConversations] = useState<Conversation[]>([
    {
      ...
      participantName: "Care Agency Plus",
      ...
      messages: [
        {
          ...
          senderName: "You",
          text: "Hello! Let me check. Could you please provide your agency reference number?",
        ...
        },
        {
          id: "2",
          senderId: "agency-1",
          senderName: "Care Agency Plus",
          text: "Sure, our reference number is #AGY-123451.",
    ...
    {
      id: "2",
      participantId: "agency-2",
      participantName: "Community Care Services",
      participantRole: "Agency",
      lastMessage: "Sure, our reference number is #AGY-789012.",
      ...
      messages: [
        ...
        },
        {
          id: "2",
          senderId: "agency-2",
          senderName: "Community Care Services",
          text: "Sure, our reference number is #AGY-789012.",
          timestamp: new Date("2026-01-19T09:40:00"),
          isRead: true,
        },
        {
          ...
          senderId: user?.id || "super-admin",
          senderName: "You",
          text: "Thank you! I've found your account details. How can I assist you today?",
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-[#f9fafb]">
              <div className="space-y-4">
                {selectedConversation.messages.map((message) => {
                  const isSentByUser = message.senderId === (user?.id || "super-admin");
