  ...
  return (
    <div className="min-h-[calc(100vh-200px)] pb-20">
      ...
      <h2 className="text-[20px] font-semibold leading-[1.6] text-[#10141a] text-center mb-8 font-['Urbanist',sans-serif] whitespace-pre-wrap">
        Community Inclusion Services – Activities Log (TDHJ/3421)
      </h2>
                ...
                >
                  ...
                  <div className="px-4 py-3 border-r border-[#b2b2b3] flex items-center justify-center">
                    <div
                      ...
                      onInput={(e) => updateActivity(activity.id, 'strategies', e.currentTarget.textContent || '')}
                      className="w-full min-h-[71px] border-0 bg-transparent text-center focus:outline-none text-[14px] font-normal leading-[1.4] text-black font-['Urbanist',sans-serif] py-6"
                      dangerouslySetInnerHTML={{ __html: activity.strategies }}
                    />
                  </div>
                  {/* Activities */}
                  <div className="px-4 py-3 border-r border-[#b2b2b3] flex items-center justify-center">
                    <div
                      contentEditable
                      suppressContentEditableWarning
                      onInput={(e) => updateActivity(activity.id, 'activities', e.currentTarget.textContent || '')}
                      className="w-full min-h-[71px] border-0 bg-transparent text-center focus:outline-none text-[14px] font-normal leading-[1.4] text-black font-['Urbanist',sans-serif] py-6"
                  ...
                  <div className="px-4 py-3 border-r border-[#b2b2b3] flex items-center justify-center">
                    <div
                      contentEditable
                      suppressContentEditableWarning
                      onInput={(e) => updateActivity(activity.id, 'location', e.currentTarget.textContent || '')}
                      className="w-full min-h-[71px] border-0 bg-transparent text-center focus:outline-none text-[14px] font-normal leading-[1.4] text-black font-['Urbanist',sans-serif] py-6"
                      dangerouslySetInnerHTML={{ __html: activity.location }}
                    />
                  </div>
                  {/* Notes */}
                  <div className="px-4 py-3 flex items-center justify-center">
                    <div
                      contentEditable
                      suppressContentEditableWarning
                      onInput={(e) => updateActivity(activity.id, 'notes', e.currentTarget.textContent || '')}
                      className="w-full min-h-[71px] border-0 bg-transparent text-center focus:outline-none text-[14px] font-normal leading-[1.4] text-black font-['Urbanist',sans-serif] py-6"
