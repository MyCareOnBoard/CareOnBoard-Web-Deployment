...
export const TABLE_GRID =
  "grid grid-cols-[minmax(130px,1.4fr)_minmax(90px,1fr)_minmax(100px,1fr)_minmax(130px,1.2fr)_minmax(140px,1.3fr)_minmax(90px,0.9fr)_40px] items-center gap-3 pl-4 pr-8";
