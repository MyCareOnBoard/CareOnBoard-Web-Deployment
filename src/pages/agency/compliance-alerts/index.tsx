  ...
  const complianceAlerts = [
    {
      ...
      status: "Active",
      document: "I-9 Form",
      documentStatus: "Expired (2days ago)",
      training: "9/20",
    },
    {
      id: 2,
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-[14px] border border-[#e5e5e6] rounded-lg focus:outline-none focus:border-[#00b4b8] transition-colors"
            />
          </div>
