...
export default function AgencyPayrollSetupTab({ scope }: { scope: PayrollScope }) {
  return <div className="[&_button]:cursor-pointer"><PayrollOperationProvider><AgencyPayrollSetupContent key={JSON.stringify([scope.actorUid, scope.agencyId])} scope={scope} /></PayrollOperationProvider></div>;
}
