...
export const {useGetEmployeesNonPaginatedQuery, useSaveTrainingMutation, useGetTrainingsQuery, useLazyGetEmployeeTrainingsQuery, useGetEmployeeTrainingsQuery, useApproveTrainingMutation} = employeeTrainingsApi;
