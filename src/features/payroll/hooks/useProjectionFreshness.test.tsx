...
const projection = (clientRevalidateAfter?: string): import("../model/types").AgencyPayrollSetupProjection => ({ projectionRevision: 1, clientRevalidateAfter, integration: { state: "configured", environment: "sandbox" }, preflight: { values: {}, missingFieldCodes: [] }, readiness: { status: "ready", blockers: [], nextAction: null }, setup: { designatedSignerPresent: false, signerCandidate: null, companyLinked: false, officeWorkplaceLinked: false, payScheduleLinked: false, enrollmentProfileLocked: false }, capabilities: { canView: true, canManage: false, canCreateIntegration: false, canDesignateSigner: false, createCompanyOnboardSession: false } });
