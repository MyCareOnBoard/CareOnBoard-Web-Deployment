...
export function SignerSetupCard({ projection, onAction, hideDesignation = false, disabled = false }: { projection: AgencyPayrollSetupProjection; onAction?: (action: "designate_signer" | "clear_signer", authorityAttested?: true) => Promise<boolean>; hideDesignation?: boolean; disabled?: boolean }) {
