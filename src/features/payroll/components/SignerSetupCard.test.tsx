...
const projection = (designatedSignerPresent: boolean, canDesignateSigner = true): import("../model/types").AgencyPayrollSetupProjection => ({ projectionRevision: 1, readiness: { status: "ready", blockers: [], nextAction: null }, setup: { designatedSignerPresent, companyLinked: true, officeWorkplaceLinked: true, payScheduleLinked: true, enrollmentProfileLocked: false }, capabilities: { canView: true, canManage: true, canDesignateSigner, createCompanyOnboardSession: false } });
